  ...
  return (
    <details className="rounded-2xl border border-papyrus-line bg-paper-card/75 px-4 py-3 shadow-sm">
      <summary className="cursor-pointer list-none marker:hidden">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm font-semibold text-ink">Provenienza classificata: {classifiedPercent}%</p>
          </div>
      ...
      <div className="mt-4 border-t border-papyrus-line pt-4 text-xs leading-5 text-ink-faint">
        <p>La diagnostica controlla relazioni, intervalli temporali, target cartografici e provenance. Non misura la verità storica delle interpretazioni: quella resta espressa dallo stato epistemico e dalle fonti associate a ciascuna entità.</p>

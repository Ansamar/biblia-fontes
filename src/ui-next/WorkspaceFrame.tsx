...
export default function WorkspaceFrame({ children, context = {}, active = 'text' }: { children: React.ReactNode; context?: WorkspaceContext; active?: WorkspacePerspective }) {
  const base = context.bookSlug ? bookHref(context.bookSlug) : '/rebuild';
